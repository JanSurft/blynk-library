...
public:
    ...
    void begin(const char* name) {
        ...
        // BLE.setAdvertisedServiceUuid(pService.uuid());
...
public:
    BlynkArduinoNano_BLE(BlynkTransportArduinoNano_BLE& transp)
        : Base(transp)
...
BlynkTransportArduinoNano_BLE* BlynkTransportArduinoNano_BLE::instance = NULL;
static BlynkTransportArduinoNano_BLE _blynkTransportBLE;

BlynkArduinoNano_BLE Blynk(_blynkTransportBLE);
inline
